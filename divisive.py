...
def original_max(x, a):
    new = original_subset(x. a)
    return new.max()


def diameter(l,a):
    return original_max(l,a)


def recursive(a, indices, u, v, clusters, g, clus_s, d, parents, final):
    clus_s.append(len(indices))
    d.append(diameter(indices, a))
    parents[g] = indices
    g -= 1
    ...
    if (f == 0):
        ...
        recursive(a, store_list, x, y, clusters, g, clus_s, d, parents, final)
