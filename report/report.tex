...
\begin{document}
	...
	agglomerativo e divisivo sono stati adoperati. In seguito i soggetti dei test saranno i due metodi di clustering partizionale di cui abbiamo parlato. Infine sarà dato un quadro
	generale delle differenze riscontrate.
	\clearpage
	\subsection{Agglomerativo vs Divisivo}
	Il primo dataset, mostrato in figura \ref{c:5_c}, contiene 1000 elementi distintamente raggruppati in 5 diverse zone, così che sarà ovvio quali cluster dovrebbero essere formati.
	\begin{figure}[h]
		\centering
